var trex, trex_running, trex_collided,GAMEOVER,RESTART,IMAGEGAMEOVER,IMAGERESTART;
...
function setup() {
  ...
  GAMEOVER=createSprite(280,80,20,10);
  GAMEOVER.addImage("gameover",IMAGEGAMEOVER);
  GAMEOVER.scale=0.5
  GAMEOVER.visible=false;
  RESTART=createSprite(280,100,10,10);
  RESTART.addImage("restrat",IMAGERESTART);
  RESTART.scale=0.4;
